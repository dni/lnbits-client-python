...
class CreateLnurlAuth(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["callback", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["callback", ], str]):
