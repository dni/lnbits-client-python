...
class CreateTopup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["wallet_id", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["wallet_id", "amount", ], str]):
